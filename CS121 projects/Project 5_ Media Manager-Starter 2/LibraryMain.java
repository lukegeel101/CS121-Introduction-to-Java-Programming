...
public class LibraryMain {
   ...
   public static void main(String[] args) throws IOException{
      ...
      String userStr = "";
      /* The call to createListForTesting is for testing purposes only.
      ...
      ***********************************/
      ...
      while(keepGoing) {
         ...
         System.out.println("Enter T to list all items with a specific genre."); 
       ...
       // Check user's choice and execute it.
         ...
         //D: add a new item        
            ...
            System.out.println("What type of media? Enter B for book, M for movie, S for song, P for podcast, V for video game: ");
            ...
            if(type.equalsIgnoreCase("B")){
               ...
               System.out.println("Is this a multiplayer game? y/n: ");
               String ans = scan.nextLine();
               boolean isMultiplayer = ans.equals("y") ? true : false;
               item = new VideoGame(title, author, genre, platform, isMultiplayer);
            }
            else{
         ...
         //T: list all items with a specific genre
         else if (userStr.equalsIgnoreCase("T")){ 
            System.out.println("Enter the genre:");
            String genre = scan.nextLine();
            String[] genres = mediaList.getAllItemsByGenre(genre);
            if(genres.length>0){
               printStringArray(genres, false);
            }
            else{
               System.out.println("Could not find items with genre "+genre+" in the library.");
            }
         }
         //X: quit the app
   ...
   **/
   ...
   private static void createListForTesting(MediaList list){
       ...
       list.addItem(new VideoGame("Super Mario Odyssey", "Shigeru Miyamoto", "Platformer", "Nintendo Switch", true));
   }
}